...
@Directive({
    ...
    exportAs: 'mfDataTable' // we can export the data table with this name 
})
export class DataTable implements OnChanges, DoCheck {
    ...
    @Input("mfSortBy") public sortBy: string|string[] = "";   //sort by parameter
    @Input("mfSortOrder") public sortOrder = "asc"; // sort order parameter, "asc" or "desc"
    ...
    @Input("mfRowsOnPage") public rowsOnPage = 1000;  //number of rows should be displayed on page (default: 1000)
